...
{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-intake.jpg", width=600, height=400, op="fit") }}
...
{{ resize_image(path="./blog/repair-olympus-35sp/shutter-speed-measurement.jpg", width=600, height=400, op="fit") }}
...
{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-bottom.jpg", width=600, height=400, op="fit") }}
...
{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-top.jpg", width=600, height=400, op="fit") }}
...
{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-galvanometer-in-housing.jpg", width=600, height=400, op="fit") }}
...
{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-galvanometer-out-of-housing.jpg", width=600, height=400, op="fit") }}
...
{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-name-ring.jpg", width=600, height=400, op="fit") }}
...
{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-name-ring-cut.jpg", width=600, height=400, op="fit") }}
...
{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-lens-dissassembly-ring.jpg", width=600, height=400, op="fit") }}

The three brass rings here were supposed to be attached to this plate here:

{{ resize_image(path="./blog/repair-olympus-35sp/olympus-35sp-lens-dissassembly.jpg", width=600, height=400, op="fit") }}
